...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Statement : F_Call semicolon	<< X[0], nil >>`,
		Id:         "Statement",
		NTType:     15,
		Index:      28,
		NumSymbols: 2,
	...
	ProdTabEntry{
		String: `Id : id	<< ast.ExpressionVar{
            Id: string(X[0].(*token.Token).Lit),
        }, nil >>`,
		Id:         "Id",
		NTType:     23,
	...
	ProdTabEntry{
		String: `F_Call : id lparen F_Args rparen	<< ast.FCallNode{
            Id: string(X[0].(*token.Token).Lit),
